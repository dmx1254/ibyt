  ...
  return (
    <div className="home">
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Echangez vos kamas en toute sécurité sur ibytrade, nous vous enverrons des messages privés en jeu avec le code que vous avez choisi. "
        />
      </Helmet>
      <Helmet>
        ...
        <meta
          name="description"
          content="Vendez vos soldes au meilleur prix du marché sur ibytrade."
        />
      </Helmet>
      ...
      <div className="home-sidebar-desc">
        ...
        {language === "anglais" ? (
          <div className="dofus-desc">
            <p>
              Welcome to our webesite ibytrade where you can resell your kamas,
          ...
          <div className="dofus-desc">
            <p>
              Bienvenue sur notre site ibytrade ou vous pourrez revendre vos
